            ...
            try
            {
                foreach (var record in results)
                {
                    ...
                    var sql = $"""
                               ...
                               {(importedTransaction.contact_1_address_code == null ? "NULL" : $"'{importedTransaction.contact_1_address_code.Replace("'", "''", StringComparison.InvariantCulture)}'")},
                               ...
                               {(importedTransaction.contact_4_address_code == null ? "NULL" : $"'{importedTransaction.contact_4_address_code.Replace("'", "''", StringComparison.InvariantCulture)}'")},
