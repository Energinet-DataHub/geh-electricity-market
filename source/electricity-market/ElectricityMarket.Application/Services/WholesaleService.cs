...
namespace Energinet.DataHub.ElectricityMarket.Application.Services
{
    public class WholesaleService(
        ...
        IBalanceResponsibleRepository balanceResponsibleRepository) : IWholesaleService
    {
        ...
        public async Task<IEnumerable<WholesaleDto>> GetWholesaleMeteringPointsAsync(IAsyncEnumerable<MeteringPoint> meteringPoints)
        {
        ...
        private static List<WholesaleDto> FilterAndMergeCandidates(
            List<WholesaleDto> candidates)
        {
            var result = new List<WholesaleDto>();
        ...
        private async Task<List<WholesaleDto>> BuildCandidatesAsync(
            IAsyncEnumerable<MeteringPoint> meteringPoints)
        {
            var candidates = new List<WholesaleDto>();
