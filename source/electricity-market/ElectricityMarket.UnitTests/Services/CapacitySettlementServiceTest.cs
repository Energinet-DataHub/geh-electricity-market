...
public class CapacitySettlementServiceTest
{
    ...
    public CapacitySettlementServiceTest()
    {
    ...
    [Fact]
    public async Task GivenCapacitySettlementAttachedBefore2025_WhenFindingCapacitySettlementPeriods_ReturnedPeriodStarsIn2025Period()
    {
    ...
    [Fact]
    public async Task GivenMultipleCommercialRelations_WhenFindingCapacitySettlementPeriods_ReturnedPeriodStarsIn2025Period()
    {
    ...
    private MeteringPoint CreateParentMeteringPoint(MeteringPointIdentification parentIdentification, MeteringPointMetadata meteringPointMetadata, DateTimeOffset version, List<CommercialRelation> commercialRelations)
    {
    ...
    private MeteringPointMetadata CreateParentMeteringPointMetadata(Interval valid)
    {
    ...
    private MeteringPoint CreateCapacitySettlementChildMeteringPoint(List<MeteringPointMetadata> meteringPointMetadataList, DateTimeOffset version)
    {
        return new MeteringPoint(1, version, Any.MeteringPointIdentification(), meteringPointMetadataList, new List<CommercialRelation>());
    }

    private MeteringPointMetadata CreateCapacitySettlementMeteringPointMetadata(Interval valid, MeteringPointIdentification? parent, ConnectionState connectionState = ConnectionState.Connected)
    {
        return new MeteringPointMetadata(
            2,
            valid,
